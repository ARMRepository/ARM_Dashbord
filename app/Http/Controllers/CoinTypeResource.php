...
class CoinTypeResource extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()) {
            ...
            return view('coinadmin.cointype.index', compact('Coin'));
        }
    }
    ...
    {
        return view('coinadmin.cointype.create');
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('coinadmin.cointype.edit',compact('Coin'));
        } catch (ModelNotFoundException $e) {
            return back()->with('flash_error', 'Coin Type Not Found');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('coinadmin.cointype.index')->with('flash_success', 'Coin Type Updated Successfully');    
        } 
