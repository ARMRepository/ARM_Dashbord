...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <a href="{{ route('coinadmin.cointype.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> Back</a>

            <h5 style="margin-bottom: 2em;">Add Coin Type</h5>

            <form class="form-horizontal" action="{{route('coinadmin.cointype.update', $Coin->id )}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}
                ...
                <div class="form-group row">
                    <label for="address" class="col-xs-2 col-form-label">Coin Address</label>
                    <div class="col-xs-10">
                    ...
                    <div class="col-xs-10">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <a href="{{ route('coinadmin.cointype.index') }}" class="btn btn-danger btn-block">Cancel</a>
                            </div>
