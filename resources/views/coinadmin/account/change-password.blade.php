...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('coinadmin.password.update')}}" method="POST" role="form">
            	{{csrf_field()}}
				...
				<div class="form-group row">
					<label for="password_confirmation" class="col-xs-12 col-form-label">Confirm Password</label>
					<div class="col-xs-10">
